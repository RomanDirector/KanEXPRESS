      ...
      <main className="mx-auto max-w-6xl px-4 pt-32 pb-24">
        ...
        <div className="grid gap-8 lg:grid-cols-5">
          ...
          <div className="space-y-4 lg:col-span-2">
              ...
              >
                ...
                <div>
                  ...
                  {item.href ? (
                    <a
                      href={item.href}
                      className="mt-0.5 text-sm font-medium text-gray-900 hover:text-primary transition-colors"
                    >
                      {item.value}
                    </a>
                  ) : (
            ...
            <a
              href="https://wa.me/77000000000"
              className="flex w-full items-center justify-center gap-3 rounded-2xl bg-[#25D366] py-4 text-sm font-semibold text-white transition-all hover:bg-[#22c55e] active:scale-95"
            >
