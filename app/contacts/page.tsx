      ...
      <main className="mx-auto max-w-5xl px-6 pt-36 pb-24">
        ...
        <div className="grid gap-6 lg:grid-cols-5">
          ...
          <div className="space-y-3 lg:col-span-2">
            ...
            <a
              href="https://wa.me/77000000000"
              className="flex w-full items-center justify-center gap-3 rounded-full bg-[#25D366] py-3.5 text-sm font-semibold text-white transition-all hover:bg-[#22c55e] active:scale-95"
            >
