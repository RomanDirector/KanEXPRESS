          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {BENEFITS.map((b) => (
                  <Reveal key={b.title}>
                    <div className="rounded-2xl bg-white overflow-hidden transition-all hover:-translate-y-1 hover:shadow-md">
      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {REVIEWS.map((r) => (
              <Reveal key={r.name}>
                <div className="rounded-2xl border border-gray-100 bg-[#f8f8f8] p-6 transition-all hover:shadow-sm">
        ...
        <div className="mx-auto max-w-3xl px-6">
          ...
          <div className="space-y-2">
            {[
              ...
              <Reveal key={item.q}>
                <details className="group rounded-2xl border border-gray-100 bg-white open:shadow-sm transition-all">
          ...
          <div className="mt-12 text-center">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full bg-[#25D366] px-8 py-3.5 text-sm font-semibold text-white transition-all hover:bg-[#22c55e] active:scale-95 wa-pulse"
            >
