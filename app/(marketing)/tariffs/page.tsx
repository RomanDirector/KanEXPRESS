        ...
        <div className="mx-auto max-w-xl px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a
              ...
              className="inline-flex items-center justify-center gap-2.5 rounded-full bg-[#25D366] px-7 py-3.5 text-sm font-semibold text-white transition-all hover:bg-[#22c55e] active:scale-95"
            >
